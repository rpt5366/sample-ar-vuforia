...
namespace
{
    constexpr char licenseKey[] = "";
...
bool AppController::loadTrackerData()
{
    ...
    if (mTarget == IMAGE_TARGET_ID)
    {
        ...
        /* CHANGED CODE*/
        mCurrentDataSet = loadAndActivateDataSet("artutorial.xml");
